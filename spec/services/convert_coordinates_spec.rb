...
describe ConvertCoordinates do
  ...
  it 'should be able to take a range of positions and convert them to an array of coords' do
    expect(subject.to_numerical_coords 'A1', 'B2').to eq [[1,1],[2,2]]
  end
